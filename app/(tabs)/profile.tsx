...
export default function MyProfileScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <StatusBar backgroundColor={C.navyDark} barStyle="light-content" />
      <TopBar />
...
const styles = StyleSheet.create({
  ...
  // Scroll
  scroll: { flex: 1, backgroundColor: C.navyDark },
  scrollContent: { padding: 20, paddingBottom: 32 },

  // Page header
  pageHeader: { paddingHorizontal: 0, paddingVertical: 8 },
  pageTitle: { color: C.white, fontSize: 24, fontWeight: "700", marginBottom: 6 },
